...
<Card title="Write Content" icon="pen-to-square" href="/overview/markdown">
  Learn MDX syntax and start writing your documentation.
</Card>

<Card title="Customize style" icon="palette" href="/overview/customization">
  Make your docs match your brand perfectly.
</Card>

<Card title="Add code examples" icon="square-code" href="/overview/code">
